...
let gender = document.querySelectorAll('#form-user-create [name=gender]:checked') //Selecionando os dois radios do do formuário usando o atributo name e o pseudo atributo checked
